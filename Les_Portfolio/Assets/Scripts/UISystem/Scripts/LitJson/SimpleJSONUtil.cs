...
namespace SimpleJSONUtil
{
    // int Array wrapper struct
    [System.Serializable]
    ...
    {
        public Vector3Array(Vector3[] arr)
        {
            value = arr;
        }
    ...
    {
        public Vector2Array(Vector2[] arr)
        {
            value = arr;
        }
    ...
    public class JSONNode
    {
        ...
        protected bool m_IsValue = false;
        ...
        public virtual float AsFloat
        {
            ...
            {
                float v = 0.0f;
                if (float.TryParse(Value, System.Globalization.NumberStyles.Float, CULTURE_INFO, out v))
                    return v;
                return 0.0f;
            }
            set
        ...
        public virtual double AsDouble
        {
            ...
            {
                double v = 0.0;
                if (double.TryParse(Value, System.Globalization.NumberStyles.Float, CULTURE_INFO, out v))
                    return v;
                return 0.0;
            }
            set
    ...
    public class JSONData : JSONNode
    {
        ...
        public override string ToString()
        {
            return m_IsValue ? m_Data : "\"" + Escape(m_Data) + "\"";
        }
        public override string ToString(string aPrefix)
        {
            return m_IsValue ? m_Data : "\"" + Escape(m_Data) + "\"";
    ...
    internal class JSONLazyCreator : JSONNode
    {
        ...
        public override object AsJson
        {
            get
            {
                JSONData tmp = new JSONData(null);
                Set(tmp);
                return null;
            }
            set
